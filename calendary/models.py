...
from django.db.models.fields import CharField, DateField, IntegerField, TextField, TimeField, DateTimeField
...
class Lesson(models.Model): # все записи на уроки
    ...
    date = models.ForeignKey(Day, on_delete=models.PROTECT, related_name='lessons') # ключ к таблице дней. При дуалении дня удалаются все его записи
